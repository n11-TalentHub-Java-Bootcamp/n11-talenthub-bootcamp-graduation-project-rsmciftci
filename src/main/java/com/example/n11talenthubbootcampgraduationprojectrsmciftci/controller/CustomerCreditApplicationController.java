...
public class CustomerCreditApplicationController {
    ...
    @PostMapping("")
    public void saveCreditApplicationIfCustomerExistsIfNotSaveCustomerThenCreditApplicationAndSendSMS(CreditApplicationDto creditApplicationDto){
        creditService.saveCreditApplicationIfCustomerExistsIfNotSaveCustomerThenCreditApplicationAndSendSMS(creditApplicationDto);
        //return red/onay & limit
    }
